package com.prospective.tractorplus.api;
...
//                                                                             @Path("offset") String offset);
    ...
    Call<Item> itemUpload(
            ...
            @Field("birthday") String Date_of_registration,
            @Field("birthday1") String Date_of_manufacturing,
            @Field("birthday2") String HP,
            @Field("birthday3") String Gear_system,
            @Field("birthday4") String Hours_used,
            @Field("birthday5") String Hands_changed_drop_down
