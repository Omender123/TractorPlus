package com.example.tractorplus.ui.user;
...
import com.example.tractorplus.databinding.FragmentProfileBinding;
...
import com.example.tractorplus.ui.item.promote.adapter.ItemPromoteHorizontalListAdapter;
...
import com.example.tractorplus.viewobject.holder.UserParameterHolder;
...
//        binding.get().userHistoryTextView.setText(binding.get().userHistoryTextView.getText().toString());
        ...
        if (user.roleId.equalsIgnoreCase("4")){
            ...
            binding.get().addItemButton.setVisibility(View.VISIBLE);
        }
