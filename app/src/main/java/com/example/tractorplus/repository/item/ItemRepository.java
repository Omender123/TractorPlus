package com.example.tractorplus.repository.item;
...
//                    }
    ...
    public LiveData<Resource<Item>> uploadItem(String catId, String subCatId, String itemTypeId, String itemCurrencyId, String locationId, String locationTownshipId, String description, String price,
                                               String brand, String businessMode, String isSoldOut, String title, String address, String itemId, String userId,String Date_of_registration,String Date_of_manufacturing,String HP,String Gear_system,String Hours_used,String Hands_changed_drop_down) {
        ...
        appExecutors.networkIO().execute(() -> {
            ...
            try {
                ...
                response = psApiService.itemUpload(Config.API_KEY, catId, subCatId, itemTypeId, itemCurrencyId, locationId, locationTownshipId,
                        description, price, brand, businessMode,
                        isSoldOut, title, address, itemId, userId,Date_of_registration,Date_of_manufacturing,HP,
                        Gear_system,Hours_used,Hands_changed_drop_down).execute();
